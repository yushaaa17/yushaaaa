...
rows: [
{title: "🎮 𖢉 Mobile Legends A", rowId: prefix+"nokos", description: "Pricelist Diamond Mobile Legends A"},
{title: "🎮 𖢉 Mobile Legends B", rowId: prefix+"stock", description: "Pricelist Diamond Mobile Legends B"},
{title: "🪙 𖢉 Chip Domino", rowId: prefix+"jasapromosi", description: "Pricelist Chips Higgs Domino"},
{title: "🍳️ 𖢉 Pubg Mobile", rowId: prefix+"desinglogo", description: "Pricelist UC Pubg Mobile"},
{title: "🔫 𖢉 Free Fire", rowId: prefix+"pengajaran", description: "Pricelist Diamond Free Fire"}]},
],
footer: footer_nya,
